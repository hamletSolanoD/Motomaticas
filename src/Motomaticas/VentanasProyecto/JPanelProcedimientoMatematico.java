...
public  class JPanelProcedimientoMatematico extends JPanel implements Serializable {
	public   JPanel SuperPanel_JPaneMatematico = new JPanel(new BorderLayout());
	...
	public JPanelProcedimientoMatematico() {
		setLayout(new BorderLayout(0, 0));
		this.add(SuperPanel_JPaneMatematico,BorderLayout.CENTER);
		
		JLabel_OperacionActiva.setForeground(Constantes.PrincipalColor);
		panel.setBackground(Constantes.DetallesColor);
		SuperPanel_JPaneMatematico.add(panel, BorderLayout.NORTH);
		...
		SuperPanel_JPaneMatematico.add(splitPane);
	...
	public void AgregarBotonDeApuntes(BotonApuntes BotonApuntes) {
		...
		SuperPanel_JPaneMatematico.paintAll(SuperPanel_JPaneMatematico.getGraphics());
	}

	public  void HardReset_JPanelMatematico() {
