...
import Motomaticas.RecursosCustomizados.JDialog_NuevoCuadernoDeApuntes;
...
public class Portada extends JFrame implements ActionListener {
	public Portada() {
		setBounds(Constantes.PantallaOrdenadorX / 5, Constantes.PantallaOrdenadorY / 9,
				(int) (Constantes.PantallaOrdenadorX / 5) * 3, (int) (Constantes.PantallaOrdenadorY / 2));
		...
		switch (arg0.getActionCommand()) {
			...
			case "CargarApunte":
				...
				try {
					...
					CuadernoDeApuntesBaseLogica CuadernoDeApuntesCargado = (CuadernoDeApuntesBaseLogica) OIS
							.readObject();
