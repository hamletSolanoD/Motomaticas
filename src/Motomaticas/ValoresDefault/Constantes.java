package Motomaticas.ValoresDefault;
...
public interface Constantes {
	...
	/* objetos Matematicos que el motor los reconoce como tal */
	public enum TipoObjetoMatematico {
		Unidad, Operacion, Funcion
	 ...
	 * interfaz final
	 */
	public enum TipoDeErrorMatematico {
		...
		TipoDeErrorMatematico(String Error) {
			ErrorString = Error;
		}
