...
public class JInternalFrameOperacion extends JInternalFrame implements ActionListener, Serializable{
		...
		botonAritmetico.addActionListener(new ActionListener() {	
			...
			public void actionPerformed(ActionEvent e) {
				...
				PropiedadesDisplay.setText(BotonAlgebraicoEnfocado.getObjetoAlgebraico().toString());
					...
					else {PropiedadesDisplay.setText("Sin resultado");}
				}
	...
	public void CalcularConsolaOutput() {
		...
		if( PosibleError ==  null) { // si hay un resultado que mostrar
			...
			ConsolaOutput.setText(ConsolaOutput.getText()+" = "+((UnidadAritmetica)OperacionGeneral.getResultado()).toStringReducido());
			MainApunteFrame.panel_Visualizar.MostrarVectores(new Vector3("",90,90,90,0));
				...
				ConsolaOutput.setForeground(Constantes.DetallesSegundoColor);
				ConsolaOutput.setText(ConsolaOutput.getText()+" = "+((Vector3)OperacionGeneral.getResultado()).toStringReducido());
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		case "++":  
			...
			if(NuevoVector != null) {
			NuevoVector.setNombre(new Mensaje_EntradaDeDatos((JFrame)SwingUtilities.getRoot(this),"Ingrese etiqueta del Vector").Respuesta());
			AgregarBotonAritmetico(new BotonAritmetico(NuevoVector, NuevoVector.toStringReducido(), NuevoVector.getNombre()));
		...
		case "--":	
			...
			//System.out.println("Borrado y sin resultado");
			 	...
			 	JOptionPane.showMessageDialog(this,"Operacion no seleccionada","Error",JOptionPane.ERROR_MESSAGE);
			}
		...
		case "}": 
			...
			break;
		case "U":
			CrearUnidadAritmetica creadorPanelUnidad = new CrearUnidadAritmetica((JFrame)SwingUtilities.getRoot(this));
